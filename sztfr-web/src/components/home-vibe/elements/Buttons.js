          ...
          <Col xs="12" md="6">
            <Card>
              <CardHeader>Button with Icon</CardHeader>
                <CardBody>
                  <Button color="success"><i className="fa fa-check"/>&nbsp;Submit</Button>{' '}
                  <Button color="danger"> <i className="fa fa-close"/>&nbsp;&nbsp;Cancel</Button>{' '}
                  <Button color="primary"><i className="fa fa-cloud-upload"/>&nbsp;&nbsp;Upload</Button>{' '}
                  <Button color="secondary"><i className="fa fa-arrow-left"/>&nbsp;&nbsp;Left</Button>{' '}
                  <Button color="secondary">Right&nbsp;&nbsp;<i className="fa fa-arrow-right"/></Button>{' '}
                </CardBody>
            </Card>
          </Col>
        </Row>
          ...
          <Col xs="12" md="6">
            <Card>
              ...
              <CardBody>
                ...
                <Button color="primary" block><i className="fa fa-cloud-download"/>&nbsp;&nbsp;Block Level Button</Button>{' '}
                <Button color="secondary" block><i className="fa fa-cloud-download"/>&nbsp;&nbsp;Block Level Button</Button>{' '}
              </CardBody>
            </Card>
          </Col>
          <Col xs="12" md="6">
            <Card>
              ...
              <CardBody>
                ...
                <Button color="primary" block outline><i className="fa fa-cloud-download"/>&nbsp;&nbsp;Outline Button</Button>{' '}
                <Button color="secondary" block outline><i className="fa fa-cloud-download"/>&nbsp;&nbsp;Outline Button</Button>{' '}
              </CardBody>
            </Card>
          </Col>
        </Row>
